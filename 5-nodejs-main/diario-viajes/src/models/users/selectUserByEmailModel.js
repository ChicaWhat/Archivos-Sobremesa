...
const selectUserByEmailModel = async (email) => {
    ...
    // Por motivos de seguridad trataremos de no darle ninguna pista al usuario que está tratando
    // de logearse, así que no indicaremos si lo que está mal es el email o es la contraseña
